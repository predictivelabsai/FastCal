...
PRODUCT = 'FastCal'
BASE_URL = 'https://cal.fastsme.com'
DESCRIPTION = 'Coordinate shared calendars, availability, recurring events, reminders, FastMeet links, and public booking pages.'
KEYWORDS = ('FastCal', 'open source open team calendar', 'open team calendar software', 'SME open team calendar', 'Shared calendars and events', 'Public scheduling links', 'Availability and conflict prevention', 'FastSME', 'open source business software')
FEATURES = ('Shared calendars and events', 'Public scheduling links', 'Availability and conflict prevention')
